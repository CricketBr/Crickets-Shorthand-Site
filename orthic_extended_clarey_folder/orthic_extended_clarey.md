...
> The images are all to the same scale. The blue lines are aligned to the typing, *not to the shorthand*, and not . This was the easiest dimension to keep consistent throughout the book. Note that the original shorthand is *not* always precicely on the baseline due to the curve of the original scans.
>
...
code samples
```
<img src="assets/hasten.png" class ="myletter3" />

![](assets/hasten.png)&nbsp;**hasten**

![](assets/hasten.png)&nbsp;**hasten**  ![](assets/hasten.png)&nbsp;**hasten**  ![](assets/hasten.png)&nbsp;**hasten**   ![](assets/hasten.png)&nbsp;**hasten**   ![](assets/hasten.png)&nbsp;**hasten**  
...
![](assets/C-upper-print.png)&nbsp;**C** (uppercase print) and
![](assets/C-lower-print.png)&nbsp;**c** (lowercase print),
![](assets/l-lower-cursive.png)&nbsp;**l** (lowercase cursive) and
![](assets/e-lower-print.png)&nbsp;**e** (lowercase cursive)
...
Thus:
![](assets/ai-curved.png)&nbsp; **ai** = ![](assets/ai-angled.png);
![](assets/oy-curved.png)&nbsp;**oy** = ![](assets/oy-angled.png);
![](assets/ou-curved.png)&nbsp;**ou** = ![](assets/ou-angled.png);
![](assets/eau-curved.png)&nbsp;**eau** = ![](assets/eau-angled.png).
...
![](assets/poem.png)&nbsp;**poem**,
![](assets/serious.png)&nbsp;**serious**.
...
![](assets/S.png)&nbsp;**S**.
Thus:
![](assets/dirge.png)&nbsp;**dirge**,
![](assets/faiths.png)&nbsp;**faiths**,
![](assets/serpent.png)&nbsp;**serpent**.
...
![](assets/law-suit.png)&nbsp;**law-suit**,
![](assets/bagpipes.png)&nbsp;**bagpipes**.
The necessity for this, however, seldom arises.

**Punctuation** is effected *in the usual way*, except the *hyphen* 
![](assets/hyphen.png)&nbsp;**hyphen** and the
![](assets/dash.png)&nbsp;**dash**.
...
![](assets/scholar.png)&nbsp;**scholar**,
![](assets/scheme.png)&nbsp;**scheme**.

**Chl** maybe be written 
![](assets/Chl-2.png)&nbsp;**Chl** or
![](assets/Chl-2.png)&nbsp;**Chl**,
![](assets/chloric.png)&nbsp;**chloric**,
![](assets/richly.png)&nbsp;**richly**,
![](assets/speechless.png)&nbsp;**speechless**.

**Dv** 
![](assets/DV.png)&nbsp;:
![](assets/advert.png)&nbsp;**advert**, compare
![](assets/avert.png)&nbsp;**avert**.

**Mb**
![](assets/Mb.png)&nbsp;**Mb**:
![](assets/timber.png)&nbsp;**timber**;
![](assets/lumber.png)&nbsp;**lumber**,
![](assets/lamb.png)&nbsp;**lamb**,\
compare
![](assets/temper.png)&nbsp;**temper**,
![](assets/lumper.png)&nbsp;**lumper**,
![](assets/lamp.png)&nbsp;**lamp**.

**Nsp**
![](assets/Nsp.png)&nbsp;:
![](assets/inspirit.png)&nbsp;**inspirit**,
![](assets/inspect.png)&nbsp;**inspect**,
![](assets/ensphere.png)&nbsp;**ensphere**,
![](assets/conspire.png)&nbsp;**conspire**.
...
![](assets/epitaph.png)&nbsp;**epitaph**.
The *second* in *other cases*, thus:
![](assets/phase.png)&nbsp;**phase**,
![](assets/phlegm.png)&nbsp;**phlegm**,
![](assets/physic.png)&nbsp;**physic**.

**Phth**
![](assets/Phth.png)&nbsp;:
![](assets/phthisis.png)&nbsp;**phthisis**,
![](assets/ophthalmic.png)&nbsp;**ophthalmic**.

**Pth**
![](assets/Pth.png)&nbsp;:
![](assets/Apthorpe.png)&nbsp;**Apthorpe**,
...
![](assets/farcical.png)&nbsp;**farcical**.

**Scr**
![](assets/Scr.png)&nbsp;**Scr** (*joined above*:
![](assets/scrap.png)&nbsp;**scrap**;
compare

**Sr**
![](assets/Sr.png)&nbsp; *joined below*:
![](assets/disrank.png)&nbsp;**disrank**,

**Sh**
![](assets/Sh.png)&nbsp;:
![](assets/shop.png)&nbsp;**shop**,
![](assets/shrink.png)&nbsp;**shrink**,
![](assets/push.png)&nbsp;**push**,
![](assets/wash.png)&nbsp;**wash**.

**Sw**
![](assets/Sw.png)&nbsp;:
![](assets/swam.png)&nbsp;**swam**,
![](assets/swear.png)&nbsp;**swear**,
![](assets/answer.png)&nbsp;**answer**.
