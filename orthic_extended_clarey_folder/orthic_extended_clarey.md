...
![](assets/clarey/time.png)&nbsp;**time**,
![](assets/clarey/comet.png)&nbsp;**comet**\
**U**,![](assets/clarey/U.png)&nbsp;:
![](assets/clarey/under.png)&nbsp;**under**,
![](assets/clarey/gnu.png)&nbsp;**gnu**\
**W**,![](assets/clarey/W-arrow-both.png)&nbsp;:
![](assets/clarey/wow.png)&nbsp;**wow**,
![](assets/clarey/award.png)&nbsp;**award**\
**X**,![](assets/clarey/X.png)&nbsp;:
![](assets/clarey/exist.png)&nbsp;**exist**,
![](assets/clarey/sex.png)&nbsp;**sex**\
...
![](assets/clarey/odd.png)&nbsp;**odd**;
![](assets/clarey/coo.png)&nbsp;**coo**. \
*Exception*, 
![](assets/clarey/ee.png)&nbsp;**ee** , thus
![](assets/clarey/peep.png)&nbsp;**peep** compare
![](assets/clarey/pup.png)&nbsp;**pup**
...
![](assets/clarey/C-upper-print.png)&nbsp;**C** (uppercase print) and
![](assets/clarey/C-lower-print.png)&nbsp;**c** (lowercase print),
![](assets/clarey/l-lower-cursive.png)&nbsp;**l** (lowercase cursive) and
![](assets/clarey/e-lower-print.png)&nbsp;**e** (lowercase cursive)
...
Thus:
![](assets/clarey/ai-curved.png)&nbsp; **ai** = ![](assets/clarey/ai-angled.png);
![](assets/clarey/oy-curved.png)&nbsp;**oy** = ![](assets/clarey/oy-angled.png);
![](assets/clarey/ou-curved.png)&nbsp;**ou** = ![](assets/clarey/ou-angled.png);
![](assets/clarey/eau-curved.png)&nbsp;**eau** = ![](assets/clarey/eau-angled.png).
...
![](assets/clarey/re-enter.png)&nbsp;**re-enter**,
![](assets/clarey/boa.png)&nbsp;**boa**,
![](assets/clarey/chaos.png)&nbsp;**chaos**,
![](assets/clarey/co-opoerate.png)&nbsp;**co-opoerate**,
![](assets/clarey/Leo.png)&nbsp;**Leo**,
![](assets/clarey/fiasco.png)&nbsp;**fiasco**,
![](assets/clarey/fuel.png)&nbsp;**fuel**,
![](assets/clarey/poem.png)&nbsp;**poem**,
![](assets/clarey/serious.png)&nbsp;**serious**.
...
![](assets/clarey/er.png)&nbsp;**er**,
![](assets/clarey/th.png)&nbsp;**th**,
&c., *when* they are *followed* by
![](assets/clarey/G.png)&nbsp;**G**,
![](assets/clarey/P.png)&nbsp;**P**,
![](assets/clarey/S.png)&nbsp;**S**.
Thus:
![](assets/clarey/dirge.png)&nbsp;**dirge**,
![](assets/clarey/faiths.png)&nbsp;**faiths**,
![](assets/clarey/serpent.png)&nbsp;**serpent**.
...
![](assets/clarey/law-suit.png)&nbsp;**law-suit**,
![](assets/clarey/bagpipes.png)&nbsp;**bagpipes**.
The necessity for this, however, seldom arises.

**Punctuation** is effected *in the usual way*, except the *hyphen* 
![](assets/clarey/hyphen.png)&nbsp;**hyphen** and the
![](assets/clarey/dash.png)&nbsp;**dash**.

The *full stop* may be *indicated by a space*.

**Initial Capitals** are indicated thus
![](assets/clarey/capital-mark.png)&nbsp;**capital-mark**.
Examples:
![](assets/clarey/Jew.png)&nbsp;**Jew**,
![](assets/clarey/Wales.png)&nbsp;**Wales**,
![](assets/clarey/England.png)&nbsp;**England**,
![](assets/clarey/S.E.png)&nbsp;**S.E**,
![](assets/clarey/L.S.W.R.png)&nbsp;**L.S.W.R**.
...
**Bl**
![](assets/clarey/Bl-arrow.png)&nbsp;,
![](assets/clarey/Bl-loop.png)&nbsp;:
![](assets/clarey/black.png)&nbsp;**black**,
![](assets/clarey/sensible.png)&nbsp;**sensible**,
![](assets/clarey/bleak.png)&nbsp;**bleak**,
![](assets/clarey/trebly.png)&nbsp;**trebly**,\

**Ch**
![](assets/clarey/Ch-arrow-1.png)&nbsp;,
![](assets/clarey/Ch-arrow-2.png)&nbsp;,
![](assets/clarey/Ch-arrow-3.png)&nbsp;:\
The *first* is used in the *compounds* **Chr** and **Rch**,
![](assets/clarey/Christ.png)&nbsp;**Christ**,
![](assets/clarey/arch.png)&nbsp;**arch**.\
The *second* in the *compound* **Lch**,
![](assets/clarey/filch.png)&nbsp;**filch**;\
the *third* in *other cases*,
![](assets/clarey/chat.png)&nbsp;**chat**,
![](assets/clarey/such.png)&nbsp;**such**,
![](assets/clarey/scholar.png)&nbsp;**scholar**,
![](assets/clarey/scheme.png)&nbsp;**scheme**.

**Chl** maybe be written 
![](assets/clarey/Chl-2.png)&nbsp;**Chl** or
![](assets/clarey/Chl-2.png)&nbsp;**Chl**,
![](assets/clarey/chloric.png)&nbsp;**chloric**,
![](assets/clarey/richly.png)&nbsp;**richly**,
![](assets/clarey/speechless.png)&nbsp;**speechless**.

**Dv** 
![](assets/clarey/DV.png)&nbsp;:
![](assets/clarey/advert.png)&nbsp;**advert**, compare
![](assets/clarey/avert.png)&nbsp;**avert**.

**Mb**
![](assets/clarey/Mb.png)&nbsp;**Mb**:
![](assets/clarey/timber.png)&nbsp;**timber**;
![](assets/clarey/lumber.png)&nbsp;**lumber**,
![](assets/clarey/lamb.png)&nbsp;**lamb**,\
compare
![](assets/clarey/temper.png)&nbsp;**temper**,
![](assets/clarey/lumper.png)&nbsp;**lumper**,
![](assets/clarey/lamp.png)&nbsp;**lamp**.

**Nsp**
![](assets/clarey/Nsp.png)&nbsp;:
![](assets/clarey/inspirit.png)&nbsp;**inspirit**,
![](assets/clarey/inspect.png)&nbsp;**inspect**,
![](assets/clarey/ensphere.png)&nbsp;**ensphere**,
![](assets/clarey/conspire.png)&nbsp;**conspire**.

**Ph**
![](assets/clarey/Ph-1.png)&nbsp;,
![](assets/clarey/Ph-2.png)&nbsp; :
The *first* is used in the *compound* **Phr**, *before*
![](assets/clarey/S.png)&nbsp;**S** and
![](assets/clarey/EE.png)&nbsp;**EE**, and *final*. Thus:
![](assets/clarey/phrase.png)&nbsp;**phrase**,
![](assets/clarey/philter.png)&nbsp;**philter**,
![](assets/clarey/sulphur.png)&nbsp;**sulphur**,
![](assets/clarey/epitaph.png)&nbsp;**epitaph**.
The *second* in *other cases*, thus:
![](assets/clarey/phase.png)&nbsp;**phase**,
![](assets/clarey/phlegm.png)&nbsp;**phlegm**,
![](assets/clarey/physic.png)&nbsp;**physic**.

**Phth**
![](assets/clarey/Phth.png)&nbsp;:
![](assets/clarey/phthisis.png)&nbsp;**phthisis**,
![](assets/clarey/ophthalmic.png)&nbsp;**ophthalmic**.

**Pth**
![](assets/clarey/Pth.png)&nbsp;:
![](assets/clarey/Apthorpe.png)&nbsp;**Apthorpe**,
![](assets/clarey/depth.png)&nbsp;**depth**.

**Rc**
![](assets/clarey/Rc.png)&nbsp;**Rc**:
![](assets/clarey/force.png)&nbsp;**force**,
![](assets/clarey/tierce.png)&nbsp;**tierce**,
![](assets/clarey/mercy.png)&nbsp;**mercy**,
![](assets/clarey/farcical.png)&nbsp;**farcical**.

**Scr**
![](assets/clarey/Scr.png)&nbsp;**Scr** (*joined above*:
![](assets/clarey/scrap.png)&nbsp;**scrap**;
compare

**Sr**
![](assets/clarey/Sr.png)&nbsp; *joined below*:
![](assets/clarey/disrank.png)&nbsp;**disrank**,

**Sh**
![](assets/clarey/Sh.png)&nbsp;:
![](assets/clarey/shop.png)&nbsp;**shop**,
![](assets/clarey/shrink.png)&nbsp;**shrink**,
![](assets/clarey/push.png)&nbsp;**push**,
![](assets/clarey/wash.png)&nbsp;**wash**.

**Sw**
![](assets/clarey/Sw.png)&nbsp;:
![](assets/clarey/swam.png)&nbsp;**swam**,
![](assets/clarey/swear.png)&nbsp;**swear**,
![](assets/clarey/answer.png)&nbsp;**answer**.

**Th**
![](assets/clarey/Th.png)&nbsp;:
![](assets/clarey/this.png)&nbsp;**this**,
![](assets/clarey/threw.png)&nbsp;**threw**;
*final*
![](assets/clarey/Th-final.png)&nbsp:
